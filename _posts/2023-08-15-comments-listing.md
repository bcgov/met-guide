...
At the top right, you can click the 'Read All Comments' button which expands each submission so you can read all the comments at once. You can also click the 'Export to CSV' button which will open the comments and details into an external application (typically a spreadsheet).
