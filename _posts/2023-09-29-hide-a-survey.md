...
To hide your survey, toggle on the option _Hide Survey_ on the Survey Builder screen and save your survey.
...
When you are ready to make your survey available to be attached or cloned to an engagement, you can change its status from _Hidden_ to _Ready_ by going to the Survey Builder and toggling off the _Hide Survey_ option. Viewers and Team Members will be able to see it in the Survey Listing with a _Ready_ icon in the status column.
...
For more information on survey customization, go to [Survey Builder](/dep-guide/posts/survey-builder/).
