...
1. Go to the [Engagement Details](/dep-guide/posts/engagement-details/) page
2. Scroll to the Survey Block at the bottom of the page and click _Add Survey_
...
3. Select one of the options available: _Clone an existing Survey/Template_ or _Add an existing Survey to my engagement_
...
4. Select the survey from the drop-down list (and rename it if you are cloning it)
5. Agree to the disclaimer and statement of responsibility for Survey Designers and click _Save & Continue_
