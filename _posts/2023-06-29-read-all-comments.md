...
You can click on the comment ID number which will direct you to the Comment Review page. For more information on reviewing comments, go to the [Comment Review page](/dep-guide/posts/comment-review-page/).

You can also click the _Export to CSV_ button to download all the comments in a CSV file. For Administrators, there will be two options available: Public/Proponent and Internal Only/Detailed. Team Members can download the Public/Proponent version only.
