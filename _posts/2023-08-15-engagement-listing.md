...
After clicking _Engagements_ on the left side panel, you will be directed to the engagement listing page.
...
At the top right of the page, you can select the _+ Create Engagement_ button (Administrator only). For more information on engagement creation, go to [Create An Engagement](/dep-guide/posts/create-engagement/).
...
The first column is the Engagement Name. Clicking that link will open a preview of the engagement. For more information on the Engagement Preview page, go to [Preview & Publish Engagement](/dep-guide/posts/preview-engagement/).
...
Clicking any of the four options will open a page for reviewing comments. For more information on the Comment Review page, go to [Review Comments](/dep-guide/posts/review-comments/).
...
For more information on the Survey Preview page, go to [Preview Survey](/dep-guide/posts/preview-survey/).

For more information on the Edit Engagement page, go to [Edit an Engagement](/dep-guide/posts/edit-an-engagement/). _this will include engagement details, engagement user management, and settings_.

For more information on the Report page, go to [Report](/dep-guide/posts/report/).
